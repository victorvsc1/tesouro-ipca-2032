...
def main():
    ...
    buy = col(reader.fieldnames, ["PU Compra Manha", "PU Compra", "Preço Compra", "Preco Compra", "Preço Unitário Compra", "Preco Unitario Compra"])
    sell = col(reader.fieldnames, ["PU Venda Manha", "PU Venda", "Preço Venda", "Preco Venda", "Preço Unitário Venda", "Preco Unitario Venda"])
